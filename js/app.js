        ...
        case "heros":
			...
			while(arr.length < 10) {
			    ...
			    if(arr.indexOf(number) === -1) 
			      str = `https://gateway.marvel.com/v1/public/characters?ts=1&limit=1&offset=${number}&apikey=0cc0bbc55224cb8f34ec109ab692c2cb&hash=4e7f342316da627d9a966768f39d0702`;
			      arr.push(str);
			}
